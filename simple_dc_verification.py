...
def final_verification():
    ...
    print("\n--- VERIFICATION RESULT ---")
    if all_confirmed:
        print("SUCCESS: ALL TEAM MEMBERS CONFIRMED")
        print("SUCCESS: DC CONFIRMATION WORKING PROPERLY")
        print("SUCCESS: READY FOR PRODUCTION USE")
    else:
        print("WARNING: SOME MEMBERS NOT CONFIRMED")
        print("WARNING: NEED TO RUN DC CONFIRMATION")
